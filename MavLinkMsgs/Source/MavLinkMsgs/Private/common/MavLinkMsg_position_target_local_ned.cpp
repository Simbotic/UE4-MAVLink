...
void FMavlinkMsg_position_target_local_ned::Serialize(uint8 systemId, uint8 componentId, __mavlink_message& msg, uint16& packSize)
{
    packSize = mavlink_msg_position_target_local_ned_pack(systemId, componentId, &msg,  time_boot_ms, coordinate_frame, type_mask, x, y, z, vx, vy, vz, afx, afy, afz, yaw, yaw_rate);
}

void FMavlinkMsg_position_target_local_ned::Serialize(uint8 systemId, uint8 componentId, TSharedRef<TArray<uint8>, ESPMode::ThreadSafe>& buffer)
{
    uint16 size;
...
void FMavlinkMsg_position_target_local_ned::Deserialize(const mavlink_message_t& msg)
{
        ...
        FMemory::Memset(this, 0, MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED_LEN);
