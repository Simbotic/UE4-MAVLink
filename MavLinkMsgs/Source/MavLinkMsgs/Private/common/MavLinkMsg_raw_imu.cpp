...
void FMavlinkMsg_raw_imu::Deserialize(const mavlink_message_t& msg)
{
        ...
        time_usec = mavlink_msg_raw_imu_get_time_usec(msg);
        xacc = mavlink_msg_raw_imu_get_xacc(msg);
        yacc = mavlink_msg_raw_imu_get_yacc(msg);
        zacc = mavlink_msg_raw_imu_get_zacc(msg);
        xgyro = mavlink_msg_raw_imu_get_xgyro(msg);
        ygyro = mavlink_msg_raw_imu_get_ygyro(msg);
        zgyro = mavlink_msg_raw_imu_get_zgyro(msg);
        xmag = mavlink_msg_raw_imu_get_xmag(msg);
        ymag = mavlink_msg_raw_imu_get_ymag(msg);
        zmag = mavlink_msg_raw_imu_get_zmag(msg);
    
    #else
        uint8_t len = msg.len < MAVLINK_MSG_ID_RAW_IMU_LEN? msg.len : MAVLINK_MSG_ID_RAW_IMU_LEN;
        FMemory::Memset(this, 0, MAVLINK_MSG_ID_RAW_IMU_LEN);
