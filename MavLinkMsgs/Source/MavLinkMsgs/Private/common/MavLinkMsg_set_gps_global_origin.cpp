...
void FMavlinkMsg_set_gps_global_origin::Deserialize(const mavlink_message_t& msg)
{
        ...
        latitude = mavlink_msg_set_gps_global_origin_get_latitude(msg);
        longitude = mavlink_msg_set_gps_global_origin_get_longitude(msg);
        altitude = mavlink_msg_set_gps_global_origin_get_altitude(msg);
        target_system = mavlink_msg_set_gps_global_origin_get_target_system(msg);
        time_usec = mavlink_msg_set_gps_global_origin_get_time_usec(msg);
    
    #else
        uint8_t len = msg.len < MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN? msg.len : MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN;
        FMemory::Memset(this, 0, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN);
