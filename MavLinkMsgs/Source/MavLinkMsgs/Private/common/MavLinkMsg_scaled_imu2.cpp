...
void FMavlinkMsg_scaled_imu2::Deserialize(const mavlink_message_t& msg)
{
        ...
        time_boot_ms = mavlink_msg_scaled_imu2_get_time_boot_ms(msg);
        xacc = mavlink_msg_scaled_imu2_get_xacc(msg);
        yacc = mavlink_msg_scaled_imu2_get_yacc(msg);
        zacc = mavlink_msg_scaled_imu2_get_zacc(msg);
        xgyro = mavlink_msg_scaled_imu2_get_xgyro(msg);
        ygyro = mavlink_msg_scaled_imu2_get_ygyro(msg);
        zgyro = mavlink_msg_scaled_imu2_get_zgyro(msg);
        xmag = mavlink_msg_scaled_imu2_get_xmag(msg);
        ymag = mavlink_msg_scaled_imu2_get_ymag(msg);
        zmag = mavlink_msg_scaled_imu2_get_zmag(msg);
    
    #else
        uint8_t len = msg.len < MAVLINK_MSG_ID_SCALED_IMU2_LEN? msg.len : MAVLINK_MSG_ID_SCALED_IMU2_LEN;
        FMemory::Memset(this, 0, MAVLINK_MSG_ID_SCALED_IMU2_LEN);
