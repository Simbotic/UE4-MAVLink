...
void UMavlinkDispatch::DispatchMessage(const __mavlink_message& msg)
{
    ...
    switch(msg.msgid)
    {
        ...
        case FMavlinkMsg_change_operator_control::MsgId:
            ...
            FOnMavlinkMsg_change_operator_control.Broadcast(msg_change_operator_control);
            break;
        ...
        case FMavlinkMsg_param_request_read::MsgId:
            ...
            FOnMavlinkMsg_param_request_read.Broadcast(msg_param_request_read);
            break;
        ...
        case FMavlinkMsg_attitude_quaternion::MsgId:
            ...
            FOnMavlinkMsg_attitude_quaternion.Broadcast(msg_attitude_quaternion);
            break;
        case FMavlinkMsg_local_position_ned::MsgId:
            ...
            FOnMavlinkMsg_local_position_ned.Broadcast(msg_local_position_ned);
            break;
        case FMavlinkMsg_global_position_int::MsgId:
            ...
            FOnMavlinkMsg_global_position_int.Broadcast(msg_global_position_int);
            break;
        case FMavlinkMsg_rc_channels_scaled::MsgId:
            ...
            FOnMavlinkMsg_rc_channels_scaled.Broadcast(msg_rc_channels_scaled);
            break;
        case FMavlinkMsg_rc_channels_raw::MsgId:
            FMavlinkMsg_rc_channels_raw msg_rc_channels_raw;
            msg_rc_channels_raw.Deserialize(msg);
            FOnMavlinkMsg_rc_channels_raw.Broadcast(msg_rc_channels_raw);
            break;
        case FMavlinkMsg_servo_output_raw::MsgId:
            ...
            FOnMavlinkMsg_servo_output_raw.Broadcast(msg_servo_output_raw);
            break;
        case FMavlinkMsg_mission_request_partial_list::MsgId:
            ...
            FOnMavlinkMsg_mission_request_partial_list.Broadcast(msg_mission_request_partial_list);
            break;
        ...
        case FMavlinkMsg_mission_set_current::MsgId:
            ...
            FOnMavlinkMsg_mission_set_current.Broadcast(msg_mission_set_current);
            break;
        case FMavlinkMsg_mission_current::MsgId:
            FMavlinkMsg_mission_current msg_mission_current;
            msg_mission_current.Deserialize(msg);
            FOnMavlinkMsg_mission_current.Broadcast(msg_mission_current);
            break;
        case FMavlinkMsg_mission_request_list::MsgId:
            ...
            FOnMavlinkMsg_mission_request_list.Broadcast(msg_mission_request_list);
            break;
        case FMavlinkMsg_mission_count::MsgId:
            FMavlinkMsg_mission_count msg_mission_count;
            msg_mission_count.Deserialize(msg);
            FOnMavlinkMsg_mission_count.Broadcast(msg_mission_count);
            break;
        case FMavlinkMsg_mission_clear_all::MsgId:
            ...
            FOnMavlinkMsg_mission_clear_all.Broadcast(msg_mission_clear_all);
            break;
        case FMavlinkMsg_mission_item_reached::MsgId:
            ...
            FOnMavlinkMsg_mission_item_reached.Broadcast(msg_mission_item_reached);
            break;
        case FMavlinkMsg_mission_ack::MsgId:
            FMavlinkMsg_mission_ack msg_mission_ack;
            msg_mission_ack.Deserialize(msg);
            FOnMavlinkMsg_mission_ack.Broadcast(msg_mission_ack);
            break;
        case FMavlinkMsg_set_gps_global_origin::MsgId:
            ...
            FOnMavlinkMsg_set_gps_global_origin.Broadcast(msg_set_gps_global_origin);
            break;
        case FMavlinkMsg_gps_global_origin::MsgId:
            ...
            FOnMavlinkMsg_gps_global_origin.Broadcast(msg_gps_global_origin);
            break;
        case FMavlinkMsg_param_map_rc::MsgId:
            FMavlinkMsg_param_map_rc msg_param_map_rc;
            msg_param_map_rc.Deserialize(msg);
            FOnMavlinkMsg_param_map_rc.Broadcast(msg_param_map_rc);
            break;
        case FMavlinkMsg_mission_request_int::MsgId:
            ...
            FOnMavlinkMsg_mission_request_int.Broadcast(msg_mission_request_int);
            break;
        case FMavlinkMsg_safety_set_allowed_area::MsgId:
            ...
            FOnMavlinkMsg_safety_set_allowed_area.Broadcast(msg_safety_set_allowed_area);
            break;
        case FMavlinkMsg_safety_allowed_area::MsgId:
            ...
            FOnMavlinkMsg_safety_allowed_area.Broadcast(msg_safety_allowed_area);
            break;
        case FMavlinkMsg_attitude_quaternion_cov::MsgId:
            ...
            FOnMavlinkMsg_attitude_quaternion_cov.Broadcast(msg_attitude_quaternion_cov);
            break;
        case FMavlinkMsg_nav_controller_output::MsgId:
            ...
            FOnMavlinkMsg_nav_controller_output.Broadcast(msg_nav_controller_output);
            break;
        case FMavlinkMsg_global_position_int_cov::MsgId:
            ...
            FOnMavlinkMsg_global_position_int_cov.Broadcast(msg_global_position_int_cov);
            break;
        case FMavlinkMsg_local_position_ned_cov::MsgId:
            ...
            FOnMavlinkMsg_local_position_ned_cov.Broadcast(msg_local_position_ned_cov);
            break;
        case FMavlinkMsg_rc_channels::MsgId:
            FMavlinkMsg_rc_channels msg_rc_channels;
            msg_rc_channels.Deserialize(msg);
            FOnMavlinkMsg_rc_channels.Broadcast(msg_rc_channels);
            break;
        ...
        case FMavlinkMsg_rc_channels_override::MsgId:
            ...
            FOnMavlinkMsg_rc_channels_override.Broadcast(msg_rc_channels_override);
            break;
        ...
        case FMavlinkMsg_set_attitude_target::MsgId:
            ...
            FOnMavlinkMsg_set_attitude_target.Broadcast(msg_set_attitude_target);
            break;
        case FMavlinkMsg_attitude_target::MsgId:
            FMavlinkMsg_attitude_target msg_attitude_target;
            msg_attitude_target.Deserialize(msg);
            FOnMavlinkMsg_attitude_target.Broadcast(msg_attitude_target);
            break;
        case FMavlinkMsg_set_position_target_local_ned::MsgId:
            ...
            FOnMavlinkMsg_set_position_target_local_ned.Broadcast(msg_set_position_target_local_ned);
            break;
        case FMavlinkMsg_position_target_local_ned::MsgId:
            ...
            FOnMavlinkMsg_position_target_local_ned.Broadcast(msg_position_target_local_ned);
            break;
        case FMavlinkMsg_set_position_target_global_int::MsgId:
            ...
            FOnMavlinkMsg_set_position_target_global_int.Broadcast(msg_set_position_target_global_int);
            break;
        case FMavlinkMsg_position_target_global_int::MsgId:
            ...
            FOnMavlinkMsg_position_target_global_int.Broadcast(msg_position_target_global_int);
            break;
        case FMavlinkMsg_local_position_ned_system_global_offset::MsgId:
            ...
            FOnMavlinkMsg_local_position_ned_system_global_offset.Broadcast(msg_local_position_ned_system_global_offset);
            break;
        case FMavlinkMsg_hil_state::MsgId:
            FMavlinkMsg_hil_state msg_hil_state;
            msg_hil_state.Deserialize(msg);
            FOnMavlinkMsg_hil_state.Broadcast(msg_hil_state);
            break;
        case FMavlinkMsg_hil_controls::MsgId:
            FMavlinkMsg_hil_controls msg_hil_controls;
            msg_hil_controls.Deserialize(msg);
            FOnMavlinkMsg_hil_controls.Broadcast(msg_hil_controls);
            break;
        case FMavlinkMsg_hil_rc_inputs_raw::MsgId:
            ...
            FOnMavlinkMsg_hil_rc_inputs_raw.Broadcast(msg_hil_rc_inputs_raw);
            break;
        case FMavlinkMsg_hil_actuator_controls::MsgId:
            ...
            FOnMavlinkMsg_hil_actuator_controls.Broadcast(msg_hil_actuator_controls);
            break;
        case FMavlinkMsg_optical_flow::MsgId:
            FMavlinkMsg_optical_flow msg_optical_flow;
            msg_optical_flow.Deserialize(msg);
            FOnMavlinkMsg_optical_flow.Broadcast(msg_optical_flow);
            break;
        case FMavlinkMsg_global_vision_position_estimate::MsgId:
            ...
            FOnMavlinkMsg_global_vision_position_estimate.Broadcast(msg_global_vision_position_estimate);
            break;
        case FMavlinkMsg_vision_position_estimate::MsgId:
            ...
            FOnMavlinkMsg_vision_position_estimate.Broadcast(msg_vision_position_estimate);
            break;
        case FMavlinkMsg_vision_speed_estimate::MsgId:
            ...
            FOnMavlinkMsg_vision_speed_estimate.Broadcast(msg_vision_speed_estimate);
            break;
        case FMavlinkMsg_vicon_position_estimate::MsgId:
            ...
            FOnMavlinkMsg_vicon_position_estimate.Broadcast(msg_vicon_position_estimate);
            break;
        case FMavlinkMsg_highres_imu::MsgId:
            FMavlinkMsg_highres_imu msg_highres_imu;
            msg_highres_imu.Deserialize(msg);
            FOnMavlinkMsg_highres_imu.Broadcast(msg_highres_imu);
            break;
        ...
        case FMavlinkMsg_hil_optical_flow::MsgId:
            ...
            FOnMavlinkMsg_hil_optical_flow.Broadcast(msg_hil_optical_flow);
            break;
        case FMavlinkMsg_hil_state_quaternion::MsgId:
            ...
            FOnMavlinkMsg_hil_state_quaternion.Broadcast(msg_hil_state_quaternion);
            break;
        case FMavlinkMsg_scaled_imu2::MsgId:
            FMavlinkMsg_scaled_imu2 msg_scaled_imu2;
            msg_scaled_imu2.Deserialize(msg);
            FOnMavlinkMsg_scaled_imu2.Broadcast(msg_scaled_imu2);
            break;
        case FMavlinkMsg_log_request_list::MsgId:
            ...
            FOnMavlinkMsg_log_request_list.Broadcast(msg_log_request_list);
            break;
        case FMavlinkMsg_log_entry::MsgId:
            FMavlinkMsg_log_entry msg_log_entry;
            msg_log_entry.Deserialize(msg);
            FOnMavlinkMsg_log_entry.Broadcast(msg_log_entry);
            break;
        ...
        case FMavlinkMsg_data_transmission_handshake::MsgId:
            ...
            FOnMavlinkMsg_data_transmission_handshake.Broadcast(msg_data_transmission_handshake);
            break;
        ...
        case FMavlinkMsg_scaled_pressure2::MsgId:
            ...
            FOnMavlinkMsg_scaled_pressure2.Broadcast(msg_scaled_pressure2);
            break;
        case FMavlinkMsg_att_pos_mocap::MsgId:
            FMavlinkMsg_att_pos_mocap msg_att_pos_mocap;
            msg_att_pos_mocap.Deserialize(msg);
            FOnMavlinkMsg_att_pos_mocap.Broadcast(msg_att_pos_mocap);
            break;
        case FMavlinkMsg_set_actuator_control_target::MsgId:
            ...
            FOnMavlinkMsg_set_actuator_control_target.Broadcast(msg_set_actuator_control_target);
            break;
        case FMavlinkMsg_actuator_control_target::MsgId:
            ...
            FOnMavlinkMsg_actuator_control_target.Broadcast(msg_actuator_control_target);
            break;
        case FMavlinkMsg_altitude::MsgId:
            FMavlinkMsg_altitude msg_altitude;
            msg_altitude.Deserialize(msg);
            FOnMavlinkMsg_altitude.Broadcast(msg_altitude);
            break;
        case FMavlinkMsg_resource_request::MsgId:
            ...
            FOnMavlinkMsg_resource_request.Broadcast(msg_resource_request);
            break;
        case FMavlinkMsg_scaled_pressure3::MsgId:
            ...
            FOnMavlinkMsg_scaled_pressure3.Broadcast(msg_scaled_pressure3);
            break;
        case FMavlinkMsg_follow_target::MsgId:
            FMavlinkMsg_follow_target msg_follow_target;
            msg_follow_target.Deserialize(msg);
            FOnMavlinkMsg_follow_target.Broadcast(msg_follow_target);
            break;
        case FMavlinkMsg_control_system_state::MsgId:
            ...
            FOnMavlinkMsg_control_system_state.Broadcast(msg_control_system_state);
            break;
        case FMavlinkMsg_battery_status::MsgId:
            FMavlinkMsg_battery_status msg_battery_status;
            msg_battery_status.Deserialize(msg);
            FOnMavlinkMsg_battery_status.Broadcast(msg_battery_status);
            break;
        case FMavlinkMsg_autopilot_version::MsgId:
            ...
            FOnMavlinkMsg_autopilot_version.Broadcast(msg_autopilot_version);
            break;
        case FMavlinkMsg_landing_target::MsgId:
            FMavlinkMsg_landing_target msg_landing_target;
            msg_landing_target.Deserialize(msg);
            FOnMavlinkMsg_landing_target.Broadcast(msg_landing_target);
            break;
        ...
        case FMavlinkMsg_set_home_position::MsgId:
            ...
            FOnMavlinkMsg_set_home_position.Broadcast(msg_set_home_position);
            break;
        case FMavlinkMsg_message_interval::MsgId:
            ...
            FOnMavlinkMsg_message_interval.Broadcast(msg_message_interval);
            break;
        ...
        case FMavlinkMsg_camera_information::MsgId:
            ...
            FOnMavlinkMsg_camera_information.Broadcast(msg_camera_information);
            break;
        case FMavlinkMsg_camera_settings::MsgId:
            FMavlinkMsg_camera_settings msg_camera_settings;
            msg_camera_settings.Deserialize(msg);
            FOnMavlinkMsg_camera_settings.Broadcast(msg_camera_settings);
            break;
        case FMavlinkMsg_storage_information::MsgId:
            ...
            FOnMavlinkMsg_storage_information.Broadcast(msg_storage_information);
            break;
        case FMavlinkMsg_camera_capture_status::MsgId:
            ...
            FOnMavlinkMsg_camera_capture_status.Broadcast(msg_camera_capture_status);
            break;
        case FMavlinkMsg_camera_image_captured::MsgId:
            ...
            FOnMavlinkMsg_camera_image_captured.Broadcast(msg_camera_image_captured);
            break;
        case FMavlinkMsg_flight_information::MsgId:
            ...
            FOnMavlinkMsg_flight_information.Broadcast(msg_flight_information);
            break;
        case FMavlinkMsg_mount_orientation::MsgId:
            ...
            FOnMavlinkMsg_mount_orientation.Broadcast(msg_mount_orientation);
            break;
        case FMavlinkMsg_logging_data::MsgId:
            FMavlinkMsg_logging_data msg_logging_data;
            msg_logging_data.Deserialize(msg);
            FOnMavlinkMsg_logging_data.Broadcast(msg_logging_data);
            break;
        case FMavlinkMsg_logging_data_acked::MsgId:
            ...
            FOnMavlinkMsg_logging_data_acked.Broadcast(msg_logging_data_acked);
            break;
        case FMavlinkMsg_logging_ack::MsgId:
            FMavlinkMsg_logging_ack msg_logging_ack;
            msg_logging_ack.Deserialize(msg);
            FOnMavlinkMsg_logging_ack.Broadcast(msg_logging_ack);
            break;
        case FMavlinkMsg_video_stream_information::MsgId:
            ...
            FOnMavlinkMsg_video_stream_information.Broadcast(msg_video_stream_information);
            break;
        case FMavlinkMsg_video_stream_status::MsgId:
            ...
            FOnMavlinkMsg_video_stream_status.Broadcast(msg_video_stream_status);
            break;
        case FMavlinkMsg_wifi_config_ap::MsgId:
            FMavlinkMsg_wifi_config_ap msg_wifi_config_ap;
            msg_wifi_config_ap.Deserialize(msg);
            FOnMavlinkMsg_wifi_config_ap.Broadcast(msg_wifi_config_ap);
            break;
        case FMavlinkMsg_protocol_version::MsgId:
            ...
            FOnMavlinkMsg_protocol_version.Broadcast(msg_protocol_version);
            break;
        case FMavlinkMsg_uavcan_node_status::MsgId:
            ...
            FOnMavlinkMsg_uavcan_node_status.Broadcast(msg_uavcan_node_status);
            break;
        case FMavlinkMsg_uavcan_node_info::MsgId:
            ...
            FOnMavlinkMsg_uavcan_node_info.Broadcast(msg_uavcan_node_info);
            break;
        case FMavlinkMsg_param_ext_request_read::MsgId:
            ...
            FOnMavlinkMsg_param_ext_request_read.Broadcast(msg_param_ext_request_read);
            break;
        ...
        case FMavlinkMsg_obstacle_distance::MsgId:
            ...
            FOnMavlinkMsg_obstacle_distance.Broadcast(msg_obstacle_distance);
            break;
        case FMavlinkMsg_odometry::MsgId:
            FMavlinkMsg_odometry msg_odometry;
            msg_odometry.Deserialize(msg);
            FOnMavlinkMsg_odometry.Broadcast(msg_odometry);
            break;
        case FMavlinkMsg_trajectory_representation_waypoints::MsgId:
            ...
            FOnMavlinkMsg_trajectory_representation_waypoints.Broadcast(msg_trajectory_representation_waypoints);
            break;
        case FMavlinkMsg_trajectory_representation_bezier::MsgId:
            ...
            FOnMavlinkMsg_trajectory_representation_bezier.Broadcast(msg_trajectory_representation_bezier);
            break;
        case FMavlinkMsg_cellular_status::MsgId:
            FMavlinkMsg_cellular_status msg_cellular_status;
            msg_cellular_status.Deserialize(msg);
            FOnMavlinkMsg_cellular_status.Broadcast(msg_cellular_status);
            break;
        case FMavlinkMsg_utm_global_position::MsgId:
            ...
            FOnMavlinkMsg_utm_global_position.Broadcast(msg_utm_global_position);
            break;
        case FMavlinkMsg_debug_float_array::MsgId:
            ...
            FOnMavlinkMsg_debug_float_array.Broadcast(msg_debug_float_array);
            break;
        case FMavlinkMsg_orbit_execution_status::MsgId:
            ...
            FOnMavlinkMsg_orbit_execution_status.Broadcast(msg_orbit_execution_status);
            break;
        case FMavlinkMsg_statustext_long::MsgId:
            FMavlinkMsg_statustext_long msg_statustext_long;
            msg_statustext_long.Deserialize(msg);
            FOnMavlinkMsg_statustext_long.Broadcast(msg_statustext_long);
            break;
        case FMavlinkMsg_smart_battery_info::MsgId:
            ...
            FOnMavlinkMsg_smart_battery_info.Broadcast(msg_smart_battery_info);
            break;
        case FMavlinkMsg_smart_battery_status::MsgId:
            ...
            FOnMavlinkMsg_smart_battery_status.Broadcast(msg_smart_battery_status);
            break;
        case FMavlinkMsg_wheel_distance::MsgId:
            FMavlinkMsg_wheel_distance msg_wheel_distance;
            msg_wheel_distance.Deserialize(msg);
            FOnMavlinkMsg_wheel_distance.Broadcast(msg_wheel_distance);
            break;
